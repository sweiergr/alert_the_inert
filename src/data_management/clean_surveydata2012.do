...
use `"${PATH_OUT_DATA}/surveydataraw2012.dta"', clear

rename INTNR id
drop if id==.

/* not retistered in 2012
- age
*/
...
***different from 2013: BD instead of BF
rename BD sw_service
...
***different from 2013: BE instead of BG
rename BE sw_reliable
...
***different from 2013: BF instead of BG
rename BF sw_solar
...
***different from 2013: BG instead of BI
rename BG sw_nuclear
...
***different from 2013: BH instead of BJ
rename BH sw_family
...
***different from 2013: BI instead of BK
rename BI sw_green
...
***different from 2013: BJ instead of BK
rename BJ sw_additional
...
****different from 2013: CI instead of CJ starts
foreach x of varlist LW23_W2_a CI CJ CK CL CM CN CO{
	local a = `a'+1
	rename `x' no_sw_energy`a'
	label var no_sw_energy`a' "why have you not switched energy supplier"
	#delimit;
	label define no_sw_energy`a'l 1 "didn't know that I can switch" 2 "didn't know HOW to switch"
	...
	;
	#delimit cr
	label values no_sw_energy`a' no_sw_energy`a'l
	*check
	tab no_sw_energy`a' 
}
/*Multiple answers possible*/
/*Only asked to customers that are still with default supplier for elec and gas 
(indepentently whether they have or do not have a with or without contract) 
--> 405 persons answered
...
****different from 2013: CU instead of CV end
foreach x of varlist LW23_W2_b CQ CR CS CT CU{
	local b = `b'+1
	rename `x' no_sw_elec`b'
	label var no_sw_elec`b' "why have you not switched electricity supplier"
	#delimit;
	label define no_sw_elec`b'l 1 "didn't know that I can switch" 2 "didn't know HOW to switch"
	3 "no cheaper possibility" 4 "difficult to compare suppliers" 5 "asks too much effort"
	6 "feel well with supplier" 7 "not interested in switching" 8 "too many things could go wrong"
	48 "none of that" 50 "don't know"
	;
	#delimit cr
	label values no_sw_elec`b' no_sw_elec`b'l
	*check
	tab no_sw_elec`b'
}
...
no_sw_elec4==1 | no_sw_elec5==1 | no_sw_elec6==1 
;
#delimit cr
#delimit;
replace no_sw_possibility_elec=. if no_sw_elec1==. & no_sw_elec2==. & no_sw_elec3==. & 
no_sw_elec4==. & no_sw_elec5==. & no_sw_elec6==. 
;
#delimit cr
*test: ok
...
no_sw_elec4==2 | no_sw_elec5==2 | no_sw_elec6==2 
;
#delimit cr
#delimit;
...
no_sw_elec4==3 | no_sw_elec5==3 | no_sw_elec6==3
;
#delimit cr
#delimit;
...
no_sw_elec4==4 | no_sw_elec5==4 | no_sw_elec6==4 
;
#delimit cr
#delimit;
...
no_sw_elec4==5 | no_sw_elec5==5 | no_sw_elec6==5
;
#delimit cr
#delimit;
...
no_sw_elec4==6 | no_sw_elec5==6 | no_sw_elec6==6 
;
#delimit cr
#delimit;
...
no_sw_elec4==7 | no_sw_elec5==7 | no_sw_elec6==7 
;
#delimit cr
#delimit;
...
no_sw_elec4==8 | no_sw_elec5==8 | no_sw_elec6==8 
;
#delimit cr
#delimit;
...
no_sw_elec4==48 | no_sw_elec5==48 | no_sw_elec6==48
;
#delimit cr
#delimit;
...
no_sw_elec4==50 | no_sw_elec5==50 | no_sw_elec6==50 
;
#delimit cr
#delimit;
...
foreach x of varlist EI2 K L{
	local c = `c'+1
	rename `x' heating`c'
	label var heating`c' "heating device"
	#delimit ;
	label define heating`c'l 1 "electricity (main heating)" 2 "electricity (secondary heating)"
	3 "natural gas" 4 "oil" 5 "other" 6 "don't know"
	;
	#delimit cr
	label values heating`c' heating`c'l
	*check 
	tab heating`c'
}
...
replace aware_vtest=2 if aware_vtest==3
...
****different from 2013 LW15Z instead of LW15S - because question changed
...
keep weight id hometype socialhome ownership income size_hh kids gender education employment
	...
	meter consumption solar energycost price_change price_percent aware_free 
	info_liberalization aware_vreg aware_vtest done_vtest same_aware sw_intention 
	sw_intention_default sw_saving sw_saving_nb socialtariff default
...
*********************************
* Save cleaned 2012 survey as Stata file.
save `"${PATH_OUT_DATA}/surveydata2012_clean"', replace
****************************************************************************
