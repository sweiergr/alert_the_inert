...
use `"${PATH_IN_DATA}/surveyraw_2016.dta"', clear
...
gen active16=1 if P5<=4
replace active16=0 if P5==4
label var active16 "activity"
label define active16l 0 "not working"  1 "active" 
label values active16 active16l
*check
tab active16
tab P5
...
replace heating1=5 if EI15==1 | EI16==1 | EI17==1
replace heating1=6 if EI18==1
...
gen supplier=.
replace supplier=98 if LW1==27 | LW1==12 | LW1==18 | LW1==20
replace supplier=2 if LW1==3
replace supplier=9 if LW1==5
replace supplier=51 if LW1==25
replace supplier=10 if LW1==6
replace supplier=12 if LW1==13
replace supplier=14 if LW1==8
replace supplier=17 if LW1==10
replace supplier=20 if LW1==16
replace supplier=52 if LW1==26
replace supplier=24 if LW1==17
replace supplier=25 if LW1==7 | LW1==9
replace supplier=28 if LW1==19
replace supplier=99 if LW1==28
...
*check
tab no_sw_dontknow
replace no_sw_possibility=. if !(conscious==2)
replace no_sw_how=. if !(conscious==2)
replace no_sw_cheaper=. if !(conscious==2)
replace no_sw_comparison=. if !(conscious==2)
replace no_sw_effort=. if !(conscious==2)
replace no_sw_feelgood=. if !(conscious==2)
replace no_sw_interest=. if !(conscious==2)
replace no_sw_wrong=. if !(conscious==2)
replace no_sw_none=. if !(conscious==2)
replace no_sw_dontknow=. if !(conscious==2)
...
//TODO: Different from before: everyone was asked
gen aware_vtest=.
...
replace sw_intention=5 if CH4==5
label var sw_intention "Do you consider switching in the next 6 months (11-14) / at maturity (08-10)"
label define sw_intentionl 1 "not at all" 2 "probably not" 3 "probably" 4 "certainly" 5 "don't know (yet)" 6 "depends on the market price"
...
keep id hometype socialhome ownership income size_hh kids gender education 
	//employment 
	supplier conscious sw_history sw_frequency 
...
gen year = 2016
*********************************
* Save cleaned 2016 survey as Stata file.
save `"${PATH_OUT_DATA}/surveydata2016_clean"', replace
****************************************************************************
