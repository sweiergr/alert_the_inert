/*==========================================================
 * Alternative contraction mapping code that assumes firm-specific switching costs.
 ...
 * This file was used in the previous version of the paper and is now only used  for the referee response and not the material in the paper.
 * Written by Stefan Weiergraeber, April 2019
 *========================================================*/
#include "mex.h"
#include "math.h"
#include "stdio.h"
    ...
    for (mkt = 0; mkt < nM; mkt++)
    {
        ...
        while (norm > tol && iter < maxiter)
        {
            ...
            *=========================================================*/
            ...
            // mexPrintf("Sum of aggregate shares[%d]: %f \n", mkt, sum_agg_shares);
            //                 //mexPrintf("maxabsdev: %f \n",maxabsdev);
